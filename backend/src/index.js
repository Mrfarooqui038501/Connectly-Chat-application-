...
// CORS Configuration - Consistent URLs
...
server.listen(PORT, () => {
  ...
  console.log(`📝 API available at: ${process.env.NODE_ENV === "production" ? `https://connectly-chat-application.onrender.com` : `http://localhost:${PORT}`}/api`);
  connectDB();
});
